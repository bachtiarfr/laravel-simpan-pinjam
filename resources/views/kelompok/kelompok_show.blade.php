                            ...
                            <div class="row">
                                <div class="col-md-6 mb-3">
                                    <div>
                                        ...
                                        <input class="form-control {{ $errors->first('no_ktp') ? 'is-invalid' : '' }}" name="no_ktp" type="text" value="{{ $kelompok->no_ktp }}" required>
                                ...
                                <div class="col-md-6 mb-3">
                                    <div>
                                        ...
                                        <input class="form-control {{ $errors->first('nama_kelompok') ? 'is-invalid' : '' }}" name="nama_kelompok" type="text" value="{{ $kelompok->nama_kelompok }}" required>
                                        <div class="invalid-feedback">
