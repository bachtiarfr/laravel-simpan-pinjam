                        ...
                        <div class="col-lg-5 col-sm-6">
                            <div class="mb-3">
                                ...
                                <input type="text"
                                    ...
                                    {{$kelompok !=null && $approval_status=='waiting' || $approval_status=='approved'
                                    ? 'disabled' : null }}>
                            ...
                            <div class="my-3">
                                ...
                                <textarea class="form-control {{ $errors->first('alamat') ? 'is-invalid' : '' }}"
                                    ...
                                    rows="4">{{ $kelompok != null ? $kelompok->alamat : old('alamat')}}</textarea>
                                <div class="invalid-feedback">
                                    {{$errors->first('alamat')}}
                                </div>
                            </div>
                        ...
                        <div class="col-lg-5 col-sm-6">
                            <div class="mb-3">
                                ...
                                <input type="text"
                                    ...
                                    id="telepon" name="telepon" {{$kelompok !=null && $approval_status=='waiting' ||
                                    $approval_status=='approved' ? 'disabled' : null }}
                            ...
                            <div class="mb-4">
                                ...
                                <select
                                    ...
                                    $approval_status=='waiting' || $approval_status=='approved' ? 'disabled' : null }}>
